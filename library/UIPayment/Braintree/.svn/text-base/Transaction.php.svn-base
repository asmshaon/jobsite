 ...
 * <code>
 * UIPayment_Braintree_Transaction::saleNoValidate(array(
 *   'amount' => '100.00',
 *   'creditCard' => array(
 ...
 * <code>
 *   $transaction = UIPayment_Braintree_Transaction::saleNoValidate(array(
 *     'customer' => array(
 *       'firstName'    => 'Adam',
 *       'lastName'    => 'Williams'
 *     ),
...
final class UIPayment_Braintree_Transaction extends UIPayment_Braintree
{
    // Transaction Status
    ...
    {
        return self::create(array_merge($attribs, array('type' => UIPayment_Braintree_Transaction::CREDIT)));
    }
    ...
    public static function find($id)
    {
        self::_validateId($id);
        try {
            $response = UIPayment_Braintree_Http::get('/transactions/'.$id);
    ...
    {
        return self::create(array_merge(array('type' => UIPayment_Braintree_Transaction::SALE), $attribs));
    }
     ...
     * @return object UIPayment_Braintree_ResourceCollection
    ...
    public static function fetch($query, $ids)
    {
        ...
        $criteria["ids"] = UIPayment_Braintree_TransactionSearch::ids()->in($ids)->toparam();
     ...
     * @return object UIPayment_Braintree_Result_Successful|UIPayment_Braintree_Result_Error
     */
    public static function void($transactionId)
    {
        self::_validateId($transactionId);

        $response = UIPayment_Braintree_Http::put('/transactions/'. $transactionId . '/void');
    ...
    protected function _initialize($transactionAttribs)
    {
        ...
        $this->_set('creditCardDetails',
                new UIPayment_Braintree_Transaction_CreditCardDetails(
                $transactionAttribs['creditCard']
                )
            );
        $this->_set('customerDetails',
                new UIPayment_Braintree_Transaction_CustomerDetails(
                $transactionAttribs['customer']
                )
            );
        $this->_set('billingDetails',
                new UIPayment_Braintree_Transaction_AddressDetails(
        ...
        foreach ($transactionAttribs['statusHistory'] AS $history) {
            $statusHistory[] = new UIPayment_Braintree_Transaction_StatusDetails($history);
        }
    ...
    public static function refund($transactionId, $amount = null)
    {
        ...
        $response = UIPayment_Braintree_Http::post('/transactions/' . $transactionId . '/refund', $params);
        return self::_verifyGatewayResponse($response);
    }
    ...
    public function vaultCreditCard()
    {
        ...
        if (empty($token)) {
            ...
            return UIPayment_Braintree_CreditCard::find($token);
        }
    }
    ...
    public function vaultCustomer()
    {
        ...
        if (empty($customerId)) {
            ...
            return UIPayment_Braintree_Customer::find($customerId);
        }
    }
     ...
     *
     * creates a new UIPayment_Braintree_Transaction object and encapsulates
    ...
    private static function _verifyGatewayResponse($response)
    {
        if (isset($response['transaction'])) {
            // return a populated instance of UIPayment_Braintree_Transaction
    ...
    /**
     *  factory method: returns an instance of UIPayment_Braintree_Transaction
     *  to the requesting method, with populated properties
     *
     * @ignore
     * @return object instance of UIPayment_Braintree_Transaction
     */
