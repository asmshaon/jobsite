 ...
 * @copyright  2010 Braintree Payment Solutions
 */
class UIPayment_Braintree_Xml_Generator
{
    /**
    ...
    public static function arrayToXml($aData)
    {
        ...
        $writer->startElement(UIPayment_Braintree_Util::camelCaseToDelimiter($rootElementName));
        // create the body
    ...
    private static function _createElementsFromArray(&$writer, $aData)
    {
        ...
        foreach ($aData AS $index => $element) {
            ...
            $elementName = UIPayment_Braintree_Util::camelCaseToDelimiter($index, '-');
