 ...
 *
 * For example, when creating a customer, UIPayment_Braintree_Result_Successful will
 * respond to <b>customer</b> like so:
 *
 * <code>
 * <?php
 * $result = UIPayment_Braintree_Customer::create(array('first_name' => "John"));
 * if ($result->success) {
 *     // UIPayment_Braintree_Result_Successful
 ...
 * @copyright  2010 Braintree Payment Solutions
 */
class UIPayment_Braintree_Result_Successful extends UIPayment_Braintree_Instance
{
    /**
     *
    ...
    public function __construct($objToReturn = null)
    {
        if(!empty($objToReturn)) {
            ...
            $property = UIPayment_Braintree_Util::cleanClassName(
