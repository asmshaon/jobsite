 ...
 * @copyright  2010 Braintree Payment Solutions
 */
class UIPayment_Braintree_Util
{
    /**
     ...
     * of its child arrays to objects of type UIPayment_Braintree_$attributeName, or returns
     ...
     *
     * @return array array of UIPayment_Braintree_$attributeName objects, or a single element array
     */
     ...
     * @throws UIPayment_Braintree_Exception multiple types depending on the error
     *
     */
    public static function throwStatusCodeException($statusCode, $message=null)
    {
        switch($statusCode) {
         case 401:
            throw new UIPayment_Braintree_Exception_Authentication();
            break;
         case 403:
             throw new UIPayment_Braintree_Exception_Authorization($message);
            break;
         case 404:
             throw new UIPayment_Braintree_Exception_NotFound();
            break;
         case 426:
             throw new UIPayment_Braintree_Exception_UpgradeRequired();
            break;
         case 500:
             throw new UIPayment_Braintree_Exception_ServerError();
            break;
         case 503:
             throw new UIPayment_Braintree_Exception_DownForMaintenance();
            break;
         default:
            throw new UIPayment_Braintree_Exception_Unexpected('Unexpected HTTP_RESPONSE #'.$statusCode);
            break;
        }
    }

    /**
     * removes the UIPayment_Braintree_ header from a classname
     *
     * @param string $name UIPayment_Braintree_ClassName
     * @return camelCased classname minus UIPayment_Braintree_ header
     */
    public static function cleanClassName($name)
    {
        $name = str_replace('UIPayment_Braintree_', '', $name);
     ...
     * @return string UIPayment_Braintree_ClassName
     */
    public static function buildClassName($name)
    {
        return 'UIPayment_Braintree_' . ucfirst($name);
    }
