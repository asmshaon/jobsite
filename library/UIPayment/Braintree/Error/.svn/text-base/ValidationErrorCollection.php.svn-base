 ...
 */
class UIPayment_Braintree_Error_ValidationErrorCollection extends UIPayment_Braintree_Collection
{
        ...
        foreach($data AS $key => $errorData)
            ...
            if ($key == 'errors') {
                foreach ($errorData AS $error) {
                    $this->_errors[] = new UIPayment_Braintree_Error_Validation($error);
                }
            } else {
                $this->_nested[$key] = new UIPayment_Braintree_Error_ValidationErrorCollection($errorData);
            }
