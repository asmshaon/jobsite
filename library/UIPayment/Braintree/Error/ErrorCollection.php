 ...
 */
class UIPayment_Braintree_Error_ErrorCollection
{
    private $_errors;
    ...
    {
        $this->_errors =
                new UIPayment_Braintree_Error_ValidationErrorCollection($errorData);
    }
    ...
    public function onHtmlField($field)
    {
        ...
        foreach(array_slice($pieces, 0, -1) as $key) {
            $errors = $errors->forKey(UIPayment_Braintree_Util::delimiterToCamelCase($key));
     ...
     *
     * <code>
     *   $result = UIPayment_Braintree_Customer::create(...);
